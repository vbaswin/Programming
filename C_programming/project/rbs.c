...
void documentation() {
    ...
    "\n\tprocessing power\n"
    "\n\n\t** 15 rooms [8 - Deluxe & 7 - Double] will be created"
    "\n\t   whenever you start the program **\n"
    "\n\tThe locations of the rooms are created automatically\n"
    "\tbased on their area and their center distance.\n"
    "\n\tEach room has different x and y co-ordinates depending"
    "\n\ton their type and the row in which they are located.\n" 
    "\n\tThis helps to determine the nearest room more efficiently" 
    "\n\twithout overlapping\n"
